...
var MobileTouchDisabler = function(t) {
 ...
 CategorizableMap = Class.extend({
  options: {
   isInitialized: !1,
   latLng: new google.maps.LatLng(10.317684, 120.0026931),
   mapOptions: {},
   markers: {},
   categories: {},
   scrollwheel: !0,
  ...
  getLocationHtml: function(t) {
   ...
   var i = "";
   var startloc = "AppleOne Properties Inc";

   return t.address && t.suburb && t.state && t.postcode && (i = $.trim(t.address + " " + t.suburb + " " + t.state + " " + t.postcode)), 0 === i.length && t.map && (i = $.trim(t.map)), i.length > 0 && (o += '<br><div class="google-map-infowindow-actions"><a href="https://maps.google.com?saddr='+startloc+'&daddr=' + encodeURIComponent(i) + '">Get directions</a></div>'), o
  },
